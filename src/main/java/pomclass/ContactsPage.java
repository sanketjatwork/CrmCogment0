...
public class ContactsPage {
	...
	@FindBy(xpath="//div[@role='option']//span[contains(text(),'Delete')]")private WebElement DeleteOption;
	@FindBy(xpath="//div[@class='ui basic icon left attached button']")private WebElement actionComplete;
	@FindBy(xpath="//button[text()='Cancel']")private WebElement cancelAction;
	@FindBy(xpath="//button[text()='Yes']")private WebElement confirmAction;
	...
	public void clickCreate() 
{
	...
	public void tickContactCheckbox(WebDriver driver, String contactName)
	{
		...
		WebElement checkBoxContact = driver.findElement(By.xpath("//tr//td//a[contains(text(),'"+contactName+"')]//preceding::td[1]//div[@class='ui fitted read-only checkbox']"));
